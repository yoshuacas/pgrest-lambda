...
DELETE FROM "postgrest"."auth";
DELETE FROM "private"."article_stars";
DELETE FROM "private"."books";
...
DELETE FROM "public"."Server Today";
DELETE FROM "public"."Surr_Gen_Default_Upsert";
DELETE FROM "public"."UnitTest";
DELETE FROM "public"."albums";
DELETE FROM "public"."app_users";
DELETE FROM "public"."arrays";
DELETE FROM "public"."authors_only";
DELETE FROM "public"."being_part";
DELETE FROM "public"."bets";
DELETE FROM "public"."bitchar_with_length";
DELETE FROM "public"."budget_expenses";
DELETE FROM "public"."capital";
DELETE FROM "public"."car_brands";
DELETE FROM "public"."chores";
DELETE FROM "public"."clientinfo";
DELETE FROM "public"."comments";
DELETE FROM "public"."complex_items";
DELETE FROM "public"."compound_pk";
DELETE FROM "public"."compound_unique";
DELETE FROM "public"."contact";
DELETE FROM "public"."contract";
DELETE FROM "public"."datarep_next_two_todos";
DELETE FROM "public"."descendant";
DELETE FROM "public"."do$llar$s";
DELETE FROM "public"."employees";
DELETE FROM "public"."factory_buildings";
DELETE FROM "public"."family_tree";
DELETE FROM "public"."fav_numbers";
DELETE FROM "public"."ghostBusters";
DELETE FROM "public"."grandchild_entities";
DELETE FROM "public"."has_fk";
DELETE FROM "public"."images";
DELETE FROM "public"."isn_sample";
DELETE FROM "public"."items";
DELETE FROM "public"."items2";
DELETE FROM "public"."items_with_different_col_types";
DELETE FROM "public"."jobs";
DELETE FROM "public"."json_arr";
DELETE FROM "public"."json_table";
DELETE FROM "public"."jsonb_test";
DELETE FROM "public"."lines";
DELETE FROM "public"."menagerie";
DELETE FROM "public"."message";
DELETE FROM "public"."no_pk";
DELETE FROM "public"."nullable_integer";
DELETE FROM "public"."oid_test";
DELETE FROM "public"."only_pk";
DELETE FROM "public"."orders";
DELETE FROM "public"."organizations";
DELETE FROM "public"."pgrst_reserved_chars";
DELETE FROM "public"."process_costs";
DELETE FROM "public"."process_operator";
DELETE FROM "public"."process_supervisor";
DELETE FROM "public"."products_suppliers";
DELETE FROM "public"."project_invoices";
DELETE FROM "public"."ranges";
DELETE FROM "public"."safe_delete_items";
DELETE FROM "public"."safe_update_items";
DELETE FROM "public"."shop_bles";
DELETE FROM "public"."single_unique";
DELETE FROM "public"."students_info";
DELETE FROM "public"."subscriptions";
DELETE FROM "public"."suppliers_trade_unions";
DELETE FROM "public"."surr_gen_default_upsert";
DELETE FROM "public"."surr_serial_upsert";
DELETE FROM "public"."table_b";
DELETE FROM "public"."test";
DELETE FROM "public"."timestamps";
DELETE FROM "public"."tiobe_pls";
DELETE FROM "public"."touched_files";
DELETE FROM "public"."trash_details";
DELETE FROM "public"."tsearch_to_tsvector";
DELETE FROM "public"."unit_workdays";
DELETE FROM "public"."unsafe_delete_items";
DELETE FROM "public"."unsafe_update_items";
DELETE FROM "public"."users_projects";
DELETE FROM "public"."videogames";
DELETE FROM "public"."visits";
DELETE FROM "public"."w_or_wo_comma_names";
DELETE FROM "public"."web_content";
DELETE FROM "public"."withUnique";
...
DELETE FROM "private"."articles";
DELETE FROM "private"."authors";
DELETE FROM "private"."films";
DELETE FROM "private"."labels";
DELETE FROM "private"."pages";
DELETE FROM "private"."player";
DELETE FROM "private"."publishers";
DELETE FROM "private"."screens";
DELETE FROM "public"."Escap3e;";
DELETE FROM "public"."activities";
DELETE FROM "public"."addresses";
DELETE FROM "public"."artists";
DELETE FROM "public"."auto_incrementing_pk";
DELETE FROM "public"."being";
DELETE FROM "public"."budget_categories";
DELETE FROM "public"."child_entities";
DELETE FROM "public"."client";
DELETE FROM "public"."country";
DELETE FROM "public"."datarep_todos";
...
DELETE FROM "public"."users_tasks";
DELETE FROM "v1"."parents";
DELETE FROM "v2"."parents";
DELETE FROM "public"."big_projects";

...
- **[Resource embedding](./embedding)** — the six sources relationships come from, the full `select` syntax for embeds, per-embed modifiers, and the error each mistake raises.
